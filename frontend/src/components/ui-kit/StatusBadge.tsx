...
const STATUS_CONFIG: Record<string, StatusConfig> = {
  ...
  success:   { label: 'Success',    className: 'bg-success/10 text-success border border-success/25',          dot: 'bg-success' },
  ...
  approved:  { label: 'Approved',   className: 'bg-success/10 text-success border border-success/25',          dot: 'bg-success' },
  ...
  ready_to_send: { label: 'Ready to send', className: 'bg-primary/10 text-primary border border-primary/25',   dot: 'bg-primary' },
  ...
  rejected:  { label: 'Rejected',   className: 'bg-destructive/10 text-destructive border border-destructive/25', dot: 'bg-destructive' },
  expired:   { label: 'Expired',    className: 'bg-muted text-muted-foreground border border-border',          dot: 'bg-muted-foreground' },
  not_enabled: { label: 'Not enabled', className: 'bg-muted text-muted-foreground border border-border',        dot: 'bg-muted-foreground' },
