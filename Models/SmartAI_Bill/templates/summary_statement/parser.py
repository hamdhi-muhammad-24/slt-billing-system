...
def parse_summary_statement(file_path: str) -> dict:
    """Parse Summary Statement GMF file."""
    data = {
        "date_of_statement": "",
        "customer_ref_no": "",
        "invoice_number": "",
        ...
        for line in f:
            ...
            if line.startswith('BSTARTINVOICESUMMARY'):
                ...
                current_account = {
                    ...
                    "net_amount": 0, "tax_amount": 0, "gross_total": 0,
                }
                continue
            ...
            if line.startswith('SUBDOCSTART') or line.startswith('SUBDOCEND'):
                continue
            ...
            # Contact
                ...
                data["contact_company"] = value
                         ...
                         'SUMSTCONTACTADDR5'):
                if value:
                    data["contact_address"].append(value)
            ...
            # Accounts
                ...
                if key == 'ACCOUNTNO':
                    ...
                    current_account["net_amount"] = _to_float(value)
                elif key == 'INVTAXTOTAL':
                    current_account["tax_amount"] = _to_float(value)
                elif key == 'INVGROSSTOTAL':
                    current_account["gross_total"] = _to_float(value)
                elif key == 'BILLREF':
                    last_billref = value

            # Totals
            elif key == 'SUMSTNETTTOTAL':
                data["total_net"] = _to_float(value)
            elif key == 'SUMSTTAXTOTAL':
                data["total_tax"] = _to_float(value)
            elif key == 'SUMSTGROSSTOTAL':
                data["total_gross"] = _to_float(value)
